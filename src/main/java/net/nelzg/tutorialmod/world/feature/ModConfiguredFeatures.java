package net.nelzg.tutorialmod.world.feature;
...
public class ModConfiguredFeatures {
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> OVERWORLD_ZIRCON_ORE = CONFIGURED_FEATURES.register("overworld_zircon_ore",
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> END_ZIRCON_ORE = CONFIGURED_FEATURES.register("end_zircon_ore",
            () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(END_ZIRCON_ORES.get(), 7)));
    public static final RegistryObject<ConfiguredFeature<?, ?>> NETHER_ZIRCON_ORE = CONFIGURED_FEATURES.register("nether_zircon_ore",
            () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(NETHER_ZIRCON_ORES.get(), 7)));
