package net.nelzg.tutorialmod.villager;
...
public class ModVillagers {
    ...
    public static final DeferredRegister<VillagerProfession> VILLAGER_MOD_PROFESSIONS =
    ...
    public static final RegistryObject<VillagerProfession> JUMP_MASTER = VILLAGER_MOD_PROFESSIONS.register("jumpy_master",
    ...
    public static void register(IEventBus eventBus) {
        ...
        VILLAGER_MOD_PROFESSIONS.register(eventBus);
    }
}
